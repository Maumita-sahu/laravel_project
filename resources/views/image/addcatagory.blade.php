...
-->
  ...
  <!-- <p><strong>Send your personal info to:</strong> <a href="mailto:workwithus@gmail.com">workwithus@gmail.com</a></p> -->
    ...
    <form action="{{route('Addcatagory.action')}}" method="post" enctype="multipart/form-data">
            @csrf
        @if(session('error'))
      ...
      <div class="d-flex">
        <div class="form-group">
          <div class="col-md-12">
            <label class="control-label" for="name">Catagory name</label>
            <input name="catagory_name" class="form-control" type="text">
            </div>
          </div>
          ...
          <div class="form-groupn d-flex">
            ...
            <div class="col-md-2 mt-4">
             <a href="{{Route('all_catagory')}}" class="delete-btn text-dark">go back</a>
            </div>
          </div>     
      </fieldset> 
    </form>
